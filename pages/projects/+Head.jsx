export default function Head() {
  ...
  const breadcrumb = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Projects", "item": "https://novaranatureestates.com/projects/" },
    ]
  }
  ...
  return (
    <>
      <link rel="canonical" href="https://www.novaranatureestates.com/projects" />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(realEstateListing) }} />
