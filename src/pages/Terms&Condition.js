        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="text-[#111827]">
            ...
            <p className="mt-3 text-[14px] sm:text-[18px] leading-relaxed text-[#374151]">
              ...
              related to farmland / plotted development projects, including
              project features, location details, amenities, pricing
              indications, and contact facilitation.
            </p>
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
              <li>
                All information, images, videos, layouts, specifications, and
                visuals displayed on this website are{" "}
                <strong>indicative in nature</strong> and for{" "}
                <strong>informational purposes only.</strong>
              </li>
              <li>
                The developer reserves the right to{" "}
                <strong>modify, alter, or amend</strong>&nbsp; project details,
                specifications, layouts, and pricing without prior notice,
                subject to statutory approvals.
              </li>
              <li>
                Actual development may vary due to site conditions, approvals,
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
              ...
              <li>
                ...
                <strong>independent due diligence,</strong> including
                verification of land titles, approvals, zoning, and local
                regulations before making any purchase decision.
              </li>
            </ul>
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
              <li>
                Prices mentioned (if any) are indicative and subject to change
                without notice.
              </li>
              <li>
                Availability of plots/farmland is subject to confirmation at the
                time of booking.
              </li>
              <li>
                Booking is confirmed only upon receipt of the prescribed amount
                and execution of relevant agreements.
              </li>
            </ul>

            <h2 className="mt-8 font-bold text-[18px] sm:text-[24px]">
              Site Visits & Amenities
            </h2>
            <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
              <li>
                Site visits are provided for convenience and do not guarantee
                availability or final allotment.
              </li>
              <li>
                Amenities mentioned are proposed and may be delivered in phases
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
              <li>
                ...
                logos, designs, and layouts, is the intellectual property of the
                developer/brand.
              </li>
              <li>
                Unauthorized copying, reproduction, or use of content is
                strictly prohibited.
              </li>
            </ul>
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2 text-[14px] sm:text-[16px] text-[#374151]">
              <li>
                The developer shall not be liable for any direct or indirect
                loss arising from reliance on the information provided on this
                website
              </li>
              <li>
                The website may contain links to third-party platforms; the
                developer is not responsible for their content or practices.
              </li>
            </ul>
            <h2 className="mt-8 font-bold text-[18px] sm:text-[24px]">
              Governing Law
            ...
            <p className="mt-3 text-[14px] sm:text-[18px] leading-relaxed text-[#374151]">
              ...
              accordance with the laws of <strong>India</strong>, and any
              disputes shall be subject to the jurisdiction of the competent
              courts in the respective state.
            </p>
          </div>
        </div>
      </motion.div>
