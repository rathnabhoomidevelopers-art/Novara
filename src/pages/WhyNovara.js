  ...
  return (
    <div>
      ...
      >
        <motion.h1
          variants={fadeUp}
          className="relative z-10 text-center text-white font-brushelva lg:text-[50px] lg:w-[700px] sm:text-[32px] text-[30px]"
        >
        ...
        <div className="w-[336px] lg:w-[988px] relative mt-[30px] lg:mt-[100px] lg:h-[376px] mx-auto">
          ...
          <div className="flex justify-center absolute z-10 -top-14 left-20">
            <div className="bg-[#1A614F] hidden px-4 gap-[60px] lg:flex font-urbanist  w-[826px] h-[102px] rounded-3xl mx-auto">
              <div className="py-3 ps-3 flex flex-col items-center text-center">
                <img src="/images/about_1.svg" />
                <p className="text-white pt-1 text-[16px]">
                  Sustainable Living
                </p>
              </div>
              <div className="py-3  flex flex-col items-center text-center">
                <img src="/images/about_2.svg" />
                <p className="text-white pt-1 text-[16px]">Long-Term Value</p>
              </div>
      ...
      <div className="h-[1753px] w-full max-w-[390px] mx-auto py-[40px] px-[8px] lg:max-w-none lg:w-full lg:px-[80px] lg:py-[80px] lg:h-[1020px] bg-[#1F5C57] overflow-x-hidden">
        ...
        <div className="pt-[6px] px-3 font-urbanist">
          ...
          <div className="py-[30px] lg:pt-[60px] lg:pb-[90px] font-urbanist">
            <div className="flex flex-col gap-[20px] lg:gap-10 lg:flex-row">
              {/*Parent block*/}
              <div>
                ...
                <div className="border-2 border-[#62A77F] rounded-tr-xl rounded-br-xl rounded-bl-xl p-[30px] lg:p-[40px] bg-gradient-to-br from-[#6FAE9E] via-[#3C7F75]/40 to-[#D5FFE6]/0 w-full max-w-[357px] h-[164px] lg:max-w-[413px] lg:h-[198px]">
                  ...
                  <p className="text-[14px] lg:text-[16px] text-[#CFCACA] pt-[16px]">
                    Discover thoughtfully planned farmlands near Bangalore,
                    designed for sustainable living, long-term value, and easy
                    accessibility.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="border-2 border-[#62A77F] rounded-tr-xl rounded-br-xl rounded-bl-xl p-[30px] lg:p-[40px] bg-gradient-to-br from-[#6FAE9E] via-[#3C7F75]/40 to-[#D5FFE6]/0 w-full max-w-[357px] h-[164px] lg:max-w-[413px] lg:h-[198px]">
                  ...
                  <p className="text-[14px] lg:text-[16px] text-[#CFCACA] pt-[16px]">
                    Shortlist plots based on location, soil quality, water
                    availability, and future growth potential guided by our
                    expert team.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="border-2 border-[#62A77F] rounded-tr-xl rounded-br-xl rounded-bl-xl p-[30px] lg:p-[40px] bg-gradient-to-br from-[#6FAE9E] via-[#3C7F75]/40 to-[#D5FFE6]/0 w-full max-w-[357px] h-[164px] lg:max-w-[413px] lg:h-[198px]">
                  ...
                  <p className="text-[14px] lg:text-[16px] text-[#CFCACA] pt-[16px]">
                    Have questions? Our farmland specialists assist you with
                    legal clarity, investment insights, and project details at
                    every stage.
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col mt-[20px] lg:mt-[40px] gap-[20px] lg:gap-10 lg:flex-row">
              {/*Parent block*/}
              <div>
                <div className="text-[#FFBA00] h-[52px] flex items-center text-[16px] border-l-2 border-[#FFCE4C] ps-4">
                  Step 04
                ...
                <div className="border-2 border-[#62A77F] rounded-tr-xl rounded-br-xl rounded-bl-xl p-[30px] lg:p-[40px] bg-gradient-to-br from-[#6FAE9E] via-[#3C7F75]/40 to-[#D5FFE6]/0 w-full max-w-[357px] h-[164px] lg:max-w-[413px] lg:h-[198px]">
                  ...
                  <p className="text-[14px] lg:text-[16px] text-[#CFCACA] pt-[16px]">
                    Experience the land in person. We arrange site visits so you
                    can see the location, surroundings, and development
                    firsthand.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="border-2 border-[#62A77F] rounded-tr-xl rounded-br-xl rounded-bl-xl p-[30px] lg:p-[40px] bg-gradient-to-br from-[#6FAE9E] via-[#3C7F75]/40 to-[#D5FFE6]/0 w-full max-w-[357px] h-[164px] lg:max-w-[413px] lg:h-[198px]">
                  ...
                  <p className="text-[14px] lg:text-[16px] text-[#CFCACA] pt-[16px]">
                    We support you with transparent documentation, legal
                    verification, and clear pricing so you invest with complete
                    confidence.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="border-2 border-[#62A77F] rounded-tr-xl rounded-br-xl rounded-bl-xl p-[30px] lg:p-[40px] bg-gradient-to-br from-[#6FAE9E] via-[#3C7F75]/40 to-[#D5FFE6]/0 w-full max-w-[357px] h-[164px] lg:max-w-[413px] lg:h-[198px]">
                  ...
                  <p className="text-[14px] lg:text-[16px] text-[#CFCACA] pt-[16px]">
                    From booking to registration, we ensure a smooth,
                    hassle-free process to help you own your farmland with ease.
                  </p>
                </div>
              </div>
            </div>
