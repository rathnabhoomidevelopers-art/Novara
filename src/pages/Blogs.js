    ...
    <div className="font-urbanist">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7">
          {BLOGS.map((blog) => (
            <div key={blog.id} className="rounded-[22px] bg-white p-3 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
              <div className="overflow-hidden rounded-[16px]">
                {/* ✅ Plain <a> replaces <Link> */}
                <a href={`/blogs/${blog.slug}`}>
                  <img src={blog.image} alt={blog.title} className="lg:h-[200px] w-full object-cover" />
                </a>
              </div>
